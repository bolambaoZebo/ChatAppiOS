...
extension DatabaseManager {
    ...
    public func createConversation(with otherEmail: String, name: String, messageKind: Message, completion: @escaping (Bool) -> Void){
        
        let safeEmail = DatabaseManager.safeEmail(emailAddress: "chatroom")
        ...
        ref.observeSingleEvent(of: .value) { [weak self] snapshot in
            ...
            let messageDate = messageKind.sentDate
            ...
            let newMessage: [String: Any] = [
                "id" : messageKind.messageId,
                "type" : messageKind.kind.messageKindString,
                "content" : message,
                "date" : dateString,
            ...
            if var messages = userNode["messages"] as? [[String: Any]] {
                messages.append(newMessage)
                userNode["messages"] = messages
                ...
                ref.setValue(value, withCompletionBlock: { [weak self] error, _ in
                    guard error == nil else {
